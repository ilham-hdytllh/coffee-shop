...
class CartItemManyCat extends StatelessWidget {
  const CartItemManyCat({super.key});
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(7.r),
                    border: Border.all(width: 1, color: CustomColor.brown)),
                child: Center(
                  child: Text(
                    "1",
                    style: CustomTextStyle.text3.copyWith(
                        color: CustomColor.white, fontWeight: FontWeight.w600),
                  ),
                ),
              ),
              Container(
